 ...
 * Command line was: qdbusxml2cpp org.lyrics.service.xml -i DBusServiceAdaptor
 * -a DBuseServiceAdaptor
 *
...
class ServiceAdaptor : public QDBusAbstractAdaptor
{
    ...
    Q_CLASSINFO(
        ...
        "name=\"currentTranslatedLyric\"/>\n"
        "    <property access=\"read\" type=\"n\" name=\"index\"/>\n"
        "    <property access=\"read\" type=\"b\" name=\"hasTranslation\"/>\n"
        "    <signal name=\"songChanged\">\n"
        "      <arg direction=\"out\" type=\"b\" name=\"has_translation\"/>\n"
        "      <arg direction=\"out\" type=\"as\" name=\"lyrics\"/>\n"
        "      <arg direction=\"out\" type=\"as\" "
        "name=\"translated_lyrics\"/>\n"
        "    </signal>\n"
        "    <signal name=\"lyricChanged\">\n"
        "      <arg direction=\"out\" type=\"n\" name=\"index\"/>\n"
        "      <arg direction=\"out\" type=\"s\" name=\"lyric\"/>\n"
        "      <arg direction=\"out\" type=\"s\" name=\"translated_lyric\"/>\n"
        "    </signal>\n"
        "    <method name=\"quit\"/>\n"
        "  </interface>\n"
        "")
  ...
  public Q_SLOTS: // METHODS
    void quit();
  Q_SIGNALS: // SIGNALS
    void lyricChanged(short index, const QString &lyric,
                      const QString &translated_lyric);
    void songChanged(bool has_translation, const QStringList &lyrics,
                     const QStringList &translated_lyrics);
};
